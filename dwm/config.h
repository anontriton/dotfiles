/* configuration file for dwm by iverson lai */

/* dependencies:
 * dmenu, st, firefox, ranger, pcmanfm, zoom
...
#define FILE_MAN_T "ranger"
#define FILE_MAN_G "pcmanfm"
...
static unsigned int baralpha        = 165;  /* choose values from 0 - 255 */
static unsigned int borderalpha     = 190;  /* 255 is opaque */
...
/* colors */
#include "/home/iverson/.local/src/dwm/themes/catppuccin.h" /* importing theme */
...
const char *spcmd2[] = { "st", "-n", "spfm", "-g", "120x40", "-e", FILE_MAN_T, NULL };
...
{ "zoom",        NULL,     "Zoom Meeting", 0,         1,          0,           0,        -1 },  
...
static const char *browser[]     = { WEB_BROWSER, NULL };
static const char *filemanager[] = { FILE_MAN_G, NULL };
...
static const Key keys[] = {
    ...
    { MODKEY,                       XK_space,     togglefloating, {0} }, /* toggle float for focused window */
    ...
    { MODKEY|ShiftMask,             XK_backslash, togglescratch,  {.ui = 1 } }, /* open second scratchpad */
...
static const Button buttons[] = {
    ...
    { ClkClientWin,         MODKEY,         Button3,        resizemouse,    {0} }, /* rezie window */
